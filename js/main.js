...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MarqueeNodes: () => (/* binding */ MarqueeNodes)
/* harmony export */ });
...
class MarqueeNodes {
    ...
    wrap() {
        ...
        nodes.forEach((node) => {
            ...
            if (node.nodeType === 3) {
                ...
                const wrapper = _internal_env__WEBPACK_IMPORTED_MODULE_0__.doc.createElement('span');
                const { style } = wrapper;
     ...
     */
    cloneAll(times) {
        if (!(0,_internal_isFiniteNumber__WEBPACK_IMPORTED_MODULE_1__.isFiniteNumber)(times) || times <= 0) {
            return;
        }
...
/* harmony import */ var _internal_isFiniteNumber__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../internal/isFiniteNumber */ "./node_modules/vevet/lib/esm/internal/isFiniteNumber.js");
/* harmony import */ var _internal_noopIfDestroyed__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../internal/noopIfDestroyed */ "./node_modules/vevet/lib/esm/internal/noopIfDestroyed.js");
/* harmony import */ var _internal_textDirection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../internal/textDirection */ "./node_modules/vevet/lib/esm/internal/textDirection.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils */ "./node_modules/vevet/lib/esm/utils/common/toPixels.js");
/* harmony import */ var _utils_listeners__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils/listeners */ "./node_modules/vevet/lib/esm/utils/listeners/addEventListener.js");
/* harmony import */ var _utils_listeners__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utils/listeners */ "./node_modules/vevet/lib/esm/utils/listeners/onResize.js");
/* harmony import */ var _utils_math__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../utils/math */ "./node_modules/vevet/lib/esm/utils/math/loop.js");
/* harmony import */ var _Raf__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Raf */ "./node_modules/vevet/lib/esm/components/Raf/index.js");
/* harmony import */ var _Nodes__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Nodes */ "./node_modules/vevet/lib/esm/components/Marquee/Nodes/index.js");
/* harmony import */ var _props__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./props */ "./node_modules/vevet/lib/esm/components/Marquee/props.js");
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./styles */ "./node_modules/vevet/lib/esm/components/Marquee/styles.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * @group Components
 */
class Marquee extends _base_Module__WEBPACK_IMPORTED_MODULE_0__.Module {
    ...
    constructor(props, onCallbacks) {
        ...
        // Update direction
        const isRtl = (0,_internal_textDirection__WEBPACK_IMPORTED_MODULE_4__.getTextDirection)(container) === 'rtl' && direction === 'horizontal';
        this._isRtl = isRtl;
        // Apply base styles to the container
        (0,_styles__WEBPACK_IMPORTED_MODULE_12__.appleMarqueeContainerStyles)({ container, isVertical, isRtl });
        // Create nodes manager
        this._nodes = new _Nodes__WEBPACK_IMPORTED_MODULE_10__.MarqueeNodes(this);
        // Setup elements in the marquee
        this._setup();
        // Create animation frame
        this._raf = new _Raf__WEBPACK_IMPORTED_MODULE_9__.Raf({ enabled: this.props.enabled, fpsRecalcFrames: 1 });
        // Set events
        this._setEvents();
    }
    ...
    /** Marquee gap */
    get gap() {
        return Math.max((0,_utils__WEBPACK_IMPORTED_MODULE_5__.toPixels)(this.props.gap), 0);
    }
    ...
    _setEvents() {
        ...
        this._raf.on('frame', () => {
            ...
            const speed = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.toPixels)(props.speed);
            this._render(speed * factor);
        });
        // Pause on hover
        const mouseenter = (0,_utils_listeners__WEBPACK_IMPORTED_MODULE_6__.addEventListener)(container, 'mouseenter', () => {
            if (this.props.pauseOnHover) {
                this._raf.pause();
            }
        });
        // Resume on mouse leave
        const mouseleave = (0,_utils_listeners__WEBPACK_IMPORTED_MODULE_6__.addEventListener)(container, 'mouseleave', () => {
            if (this.props.enabled) {
                this._raf.play();
            }
        });
    ...
    _setup() {
        ...
        this.resize();
        // Resize on page load
        const onPageLoad = (0,_global_initVevet__WEBPACK_IMPORTED_MODULE_1__.initVevet)().onLoad(() => this.resize());
        // Handle resizing
        const resizeHandler = (0,_utils_listeners__WEBPACK_IMPORTED_MODULE_7__.onResize)({
    ...
    resize() {
        ...
        if (props.cloneNodes && (0,_internal_isFiniteNumber__WEBPACK_IMPORTED_MODULE_2__.isFiniteNumber)(copyTimes) && copyTimes > 1) {
    ...
    _render(stepProp = this.props.speed) {
        ...
        const step = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.toPixels)(rawStep);
        if (!(0,_internal_isFiniteNumber__WEBPACK_IMPORTED_MODULE_2__.isFiniteNumber)(step)) {
            return;
        }
        ...
        for (let index = 0; index < elements.length; index += 1) {
            ...
            const { style } = element;
            const coord = (0,_utils_math__WEBPACK_IMPORTED_MODULE_8__.loop)(position + prevStaticCoord, -elementSize, this._totalSize - elementSize);
    ...
    _destroy() {
        ...
        (0,_styles__WEBPACK_IMPORTED_MODULE_12__.removeMarqueeContainerStyles)(container);
    }
}
__decorate([
    _internal_noopIfDestroyed__WEBPACK_IMPORTED_MODULE_3__.noopIfDestroyed
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   appleMarqueeContainerStyles: () => (/* binding */ appleMarqueeContainerStyles),
/* harmony export */   removeMarqueeContainerStyles: () => (/* binding */ removeMarqueeContainerStyles)
/* harmony export */ });
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils */ "./node_modules/vevet/lib/esm/utils/listeners/addEventListener.js");
/* harmony import */ var _props__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./props */ "./node_modules/vevet/lib/esm/components/Pointers/props.js");
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles */ "./node_modules/vevet/lib/esm/components/Pointers/styles.js");
...
class Pointers extends _base__WEBPACK_IMPORTED_MODULE_0__.Module {
     ...
     */
    _getStatic() {
        return Object.assign(Object.assign({}, super._getStatic()), _props__WEBPACK_IMPORTED_MODULE_4__.STATIC_PROPS);
    }
    /**
     * Returns the default mutable properties.
     */
    _getMutable() {
        return Object.assign(Object.assign({}, super._getMutable()), _props__WEBPACK_IMPORTED_MODULE_4__.MUTABLE_PROPS);
    }
    constructor(props, onCallbacks) {
        super(props, onCallbacks);
        /**
    ...
    get minPointers() {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_2__.clamp)(this.props.minPointers, 1, Infinity);
    }
    /** Returns the maximum number of pointers that can be tracked. */
    get maxPointers() {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_2__.clamp)(this.props.maxPointers, this.props.minPointers, Infinity);
    }
    /**
    ...
    _setBaseEvents() {
        ...
        const pointerdown = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(container, 'pointerdown', (event) => this._handlePointerDown(event));
        const dragstart = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(container, 'dragstart', (event) => event.preventDefault(), { passive: false });
        const centralMouseDown = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(container, 'mousedown', (event) => {
            if (this.props.buttons.includes(1)) {
                event.preventDefault();
            }
        }, { passive: false });
        const contextmenu = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(container, 'contextmenu', (event) => {
    ...
    _setRuntimeEvents() {
        ...
        const pointermove = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(window, 'pointermove', (event) => this._handlePointerMove(event), { passive: false });
        const pointerup = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(window, 'pointerup', (event) => this._handlePointerUp(event), { passive: false });
        const pointercancel = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(window, 'pointercancel', () => this._handleCancel(), { passive: false });
        const blur = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.addEventListener)(window, 'blur', () => this._handleCancel());
    ...
    _handlePointerDown(event) {
        ...
        if (props.disableUserSelect) {
            _internal_env__WEBPACK_IMPORTED_MODULE_1__.body.append(_styles__WEBPACK_IMPORTED_MODULE_5__.styles);
        }
    ...
    _cleanup() {
        ...
        if (this.props.disableUserSelect) {
            ...
            _styles__WEBPACK_IMPORTED_MODULE_5__.styles === null || _styles__WEBPACK_IMPORTED_MODULE_5__.styles === void 0 ? void 0 : _styles__WEBPACK_IMPORTED_MODULE_5__.styles.remove();
        }
    }
    /**
...
class SwipeCoords {
    ...
    setStart(matrix) {
        this._timestamp = performance.now();
        this._start = Object.assign({}, matrix);
        this._prev = Object.assign({}, matrix);
        this._current = Object.assign({}, matrix);
        this._diff = { x: 0, y: 0, angle: 0 };
        this._step = { x: 0, y: 0, angle: 0 };
        this._accum = { x: 0, y: 0 };
    }
    update({ x, y, angle }) {
        ...
        const prev = Object.assign({}, this.current);
...
/* harmony export */ });
/* harmony import */ var _components_Timeline__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../components/Timeline */ "./node_modules/vevet/lib/esm/components/Timeline/index.js");
/* harmony import */ var _internal_isFiniteNumber__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../internal/isFiniteNumber */ "./node_modules/vevet/lib/esm/internal/isFiniteNumber.js");
...
class SwipeInertia {
    ...
    release(onUpdate) {
        ...
        if (!(0,_internal_isFiniteNumber__WEBPACK_IMPORTED_MODULE_1__.isFiniteNumber)(duration) || duration <= 0) {
            callbacks.emit('inertiaFail', undefined);
            return;
        }
        ...
        this._timeline = new _components_Timeline__WEBPACK_IMPORTED_MODULE_0__.Timeline({ duration, easing: props.inertiaEasing });
        ...
        setTimeout(() => { var _a; return (_a = this._timeline) === null || _a === void 0 ? void 0 : _a.play(); }, 0);
    }
...
/* harmony import */ var _Pointers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Pointers */ "./node_modules/vevet/lib/esm/components/Pointers/index.js");
/* harmony import */ var _Coords__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Coords */ "./node_modules/vevet/lib/esm/components/Swipe/Coords/index.js");
/* harmony import */ var _Inertia__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Inertia */ "./node_modules/vevet/lib/esm/components/Swipe/Inertia/index.js");
/* harmony import */ var _props__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./props */ "./node_modules/vevet/lib/esm/components/Swipe/props.js");
/* harmony import */ var _Styles__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Styles */ "./node_modules/vevet/lib/esm/components/Swipe/Styles/index.js");
...
class Swipe extends _base__WEBPACK_IMPORTED_MODULE_0__.Module {
    ...
    constructor(props, onCallbacks) {
        ...
        this._coords = new _Coords__WEBPACK_IMPORTED_MODULE_4__.SwipeCoords(this);
        this._inertia = new _Inertia__WEBPACK_IMPORTED_MODULE_5__.SwipeInertia(this);
        this._styles = new _Styles__WEBPACK_IMPORTED_MODULE_7__.SwipeStyles(this);
        // create pointers
        this._pointers = new _Pointers__WEBPACK_IMPORTED_MODULE_3__.Pointers({
...
/* harmony export */   STATIC_PROPS: () => (/* binding */ STATIC_PROPS)
/* harmony export */ });
/* harmony import */ var easing_progress__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! easing-progress */ "./node_modules/easing-progress/lib/esm/easing.net/easeOutCubic.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils */ "./node_modules/vevet/lib/esm/utils/math/clamp.js");
...
const MUTABLE_PROPS = {
    ...
    inertia: false,
    inertiaDuration: (distance) => (0,_utils__WEBPACK_IMPORTED_MODULE_1__.clamp)(distance, 500, 2000),
    inertiaEasing: easing_progress__WEBPACK_IMPORTED_MODULE_0__.EaseOutCubic,
...
/* harmony import */ var _components_accordion_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/_accordion.js */ "./src/js/components/_accordion.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_components_accordion_js__WEBPACK_IMPORTED_MODULE_1__.openVisibleContent)();
  (0,_components_accordion_js__WEBPACK_IMPORTED_MODULE_1__.setAccordeonToggles)();
...
/* harmony export */ });
/* harmony import */ var _media_height_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_media-height.js */ "./src/js/components/_media-height.js");
...
const openVisibleContent = () => {
  ...
  visibleContent.forEach(element => {
    ...
    (0,_media_height_js__WEBPACK_IMPORTED_MODULE_0__.setMediaHeight)(element.scrollHeight);
  });
};
const openDetails = evt => {
  ...
  if (currentContent.classList.contains('accordion-content--opened')) {
    ...
    (0,_media_height_js__WEBPACK_IMPORTED_MODULE_0__.setMediaHeight)(currentContent.scrollHeight);
  } else {
    currentContent.style.maxHeight = null;
    (0,_media_height_js__WEBPACK_IMPORTED_MODULE_0__.setMediaHeight)(0);
  }
};
...
const recalcOpenedAccordionHeight = () => {
  ...
  openedContents.forEach(content => {
    ...
    setTimeout(() => {
      ...
      if (typeof _media_height_js__WEBPACK_IMPORTED_MODULE_0__.setMediaHeight === 'function') {
        (0,_media_height_js__WEBPACK_IMPORTED_MODULE_0__.setMediaHeight)(content.scrollHeight);
      }
    }, 0);
  });
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   setMarquee: () => (/* binding */ setMarquee)
/* harmony export */ });
/* harmony import */ var vevet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vevet */ "./node_modules/vevet/lib/esm/components/Marquee/index.js");
/* harmony import */ var vevet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vevet */ "./node_modules/vevet/lib/esm/components/Swipe/index.js");
...
/***/ "./src/js/components/_media-height.js":
/*!********************************************!*\
  !*** ./src/js/components/_media-height.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   setMediaHeight: () => (/* binding */ setMediaHeight)
/* harmony export */ });
/* harmony import */ var _vars_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../_vars.js */ "./src/js/_vars.js");
